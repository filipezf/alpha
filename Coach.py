...
class Coach():
    ...
    def learn(self):
        ...
        arena = Arena(lambda xt: np.random.choice(n_actions, 1, p= pmcts.getActionProb(xt, temp=0.2)),
                      lambda xt: np.random.choice(n_actions, 1, p= pmcts.getActionProb(xt, temp=-0.2)), self.game)
        ...
        for i in range(1, self.args.numIters+1):
            ...
            arena = Arena(lambda x: np.argmax(pmcts.getActionProb(x, temp=0.3)),
                          lambda x: np.argmax(nmcts.getActionProb(x, temp=0.3)), self.game)
